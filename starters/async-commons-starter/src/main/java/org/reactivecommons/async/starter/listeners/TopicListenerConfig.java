...
public class TopicListenerConfig extends AbstractListenerConfig {

    public TopicListenerConfig(ConnectionManager manager, DomainHandlers handlers) {
    ...
    void listen(String domain, BrokerProvider provider, HandlerResolver resolver) {
        provider.listenTopics(resolver);
    }
}
