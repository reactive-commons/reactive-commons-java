...
public class QueueListenerConfig extends AbstractListenerConfig {

    public QueueListenerConfig(ConnectionManager manager, DomainHandlers handlers) {
    ...
    void listen(String domain, BrokerProvider provider, HandlerResolver resolver) {
        provider.listenQueues(resolver);
    }
}
